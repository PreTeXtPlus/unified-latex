...
*/
function parse(str = "") {
	parseCache[str] = parseCache[str] || _unified_latex_unified_latex_util_pegjs.ArgSpecPegParser.parse(str);
...
*/
//#endregion
Object.defineProperty(exports, "ArgSpecAst", {
	enumerable: true,
	get: function() {
		return argspec_types_exports;
	}
});
exports.parse = parse;
