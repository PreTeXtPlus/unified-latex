...
var isDefMacro = match.createMacroMatcher(["def"]);
...
`;
var unifiedLatexLintNoDef = lintRule({ origin: "unified-latex-lint:no-def" }, (tree, file) => {
	visit(tree, (node) => {
...
//#endregion
export { DESCRIPTION, unifiedLatexLintNoDef };
