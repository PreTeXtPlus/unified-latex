...
var unifiedLatexLintNoTexDisplayMath = lintRule({ origin: "unified-latex-lint:no-tex-display-math" }, (tree, file, options) => {
	visit(tree, (node) => {
...
//#endregion
export { DESCRIPTION, unifiedLatexLintNoTexDisplayMath };
