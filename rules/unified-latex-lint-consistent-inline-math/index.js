...
`;
var unifiedLatexLintConsistentInlineMath = lintRule({ origin: "unified-latex-lint:consistent-inline-math" }, (tree, file, options) => {
	const inlineMath = {
		tex: [],
		latex: []
	};
...
//#endregion
export { DESCRIPTION, unifiedLatexLintConsistentInlineMath };
