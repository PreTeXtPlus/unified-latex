...
`;
var unifiedLatexLintObsoletePackages = lintRule({ origin: "unified-latex-lint:obsolete-packages" }, (tree, file, options) => {
...
//#endregion
export { DESCRIPTION, unifiedLatexLintObsoletePackages };
