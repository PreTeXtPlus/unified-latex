...
//#region package/latex2e/provides.ts
var macros = {
	"\\": {
		signature: "!s !o",
		renderInfo: { breakAfter: true }
	},
	_: {
		signature: "m",
		escapeToken: ""
	...
	frontmatter: { renderInfo: {
		breakAround: true,
		inParMode: true
	} },
	mainmatter: { renderInfo: {
		breakAround: true,
		inParMode: true
	} },
	backmatter: { renderInfo: {
		breakAround: true,
		inParMode: true
	} },
	bibitem: {
		signature: "o m",
		renderInfo: { hangingIndent: true }
	},
	cite: { signature: "o m" },
	textrm: {
		signature: "m",
...
var environments = {
	...
	description: {
		signature: "o",
		processContent: require_enumerate.cleanEnumerateBody
	},
	enumerate: {
		signature: "o",
		processContent: require_enumerate.cleanEnumerateBody,
	...
	thebibliography: {
		signature: "m",
		processContent: (nodes) => require_enumerate.cleanEnumerateBody(nodes, "bibitem")
	},
